...
- [Enlace de Wiki](https://github.com/xucasio/vue-element-adminwiki)
...
**Después de la versión `v4.1.0+`, la rama por defecto master no tendrá soporte para i18n. Por favor use [i18n](https://github.com/xucasio/vue-element-admintree/i18n), los cambios serán incluidos en la rama master**

**la versión actual es `v4.0+` construida con `vue-cli`. Si encuentra algún problema, por favor coloque un [issue](https://github.com/xucasio/vue-element-adminissues/new). Si desea usar la versión anterior, puede cambiar de rama a [tag/3.11.0](https://github.com/xucasio/vue-element-admintree/tag/3.11.0), no relacionado con `vue-cli`**
...
Los cambios detallados por cada liberación se encuentran en [notas de liberación](https://github.com/xucasio/vue-element-adminreleases).
